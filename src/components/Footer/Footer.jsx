...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-[var(--components-bg-color)] m-auto mt-8 pr-[100px] pl-[100px] max-w-[1440px] h-[643px]">
      <div className="flex justify-between items-center bg-[var(--color-black)] pr-[64px] pl-[64px] rounded-[20px] w-[1220px] h-[180px] latestOffers">
